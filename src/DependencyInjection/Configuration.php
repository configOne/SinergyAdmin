    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->scalarNode('config_type')->defaultValue('inline')->cannotBeEmpty()->end()
                ->scalarNode('config_const')->defaultValue('ADMIN_CONFIG')->cannotBeEmpty()->end()

                ->arrayNode('admin_config')
                    ->useAttributeAsKey('id')
                    ->prototype('array')
                        ->children()
                            ->scalarNode('manager_type')->defaultValue('orm')->end()
                            ->arrayNode('export_formats')
                                ->treatNullLike([])
                                ->prototype('scalar')->end()
                                ->defaultValue(['xls', 'xml', 'csv', 'json'])
                            ->end()
                            ->scalarNode('label')->defaultValue('-')->end()
                            ->scalarNode('controller')->defaultValue("Sonata\AdminBundle\Controller\CRUDController")->end()
                        ->end()
                    ->end()
                ->end()
